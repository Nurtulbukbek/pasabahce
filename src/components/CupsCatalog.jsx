...
const cupsCatalog = [
    {
        ...
        url: "/images/vineCup.png",
        height: "75%",
    },
    {
        type: "/soda",
        title: 'Бокалы для напитков',
        url: "/src/assets/sodaCup.png",
        height: "70%",
    },
    {
        type: "/ryumka",
    ...
    },
    {
        ...
        url: "/src/assets/beerCup.png",
        height: "75%",
    },
    {
        type: "/tea",
        title: 'Бокалы для чая',
        url: "/src/assets/teaCup.png",
        height: "60%",
    },
    {
        type: "/champagne",
        title: 'Фужеры для шампанского/коктейлей',
        url: "/src/assets/champagne.png",
        height: "75%",
    },
    {
        type: "/others",
