                ...
                <div className="about-us">
                    ...
                    <div className="about-us-info">
                        <div className="info-item1 info-item">
                            <p className="info-title">Изящные линии, чистый вкус.</p>
                            <p className="info-text">Наши стеклянные чашки – это больше, чем просто посуда, это воплощение утонченного вкуса.</p>
                        </div>
                        <div className="info-item2 info-item">
                            <p className="info-title">Подчеркните красоту вашего стола.</p>
                        ...
                        <div className="info-item3 info-item">
                            <p className="info-title">Идеальный подарок для себя и близких.</p>
                        ...
                        <div className="info-item4 info-item">
                            <p className="info-title">Cделано с любовью.</p>
